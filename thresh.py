...
filename = "ex2.jpg" #name of the image to count birds
min_bird = 60 #minimum number of pixels that make up a bird

##########################

fuzziness = 150
max_bird_multiplier = 2.5
...
max_bird = int(min_bird*max_bird_multiplier) #maximum number of pixels that make up a bird
